...
It controls the GCC version, libc version and the kernel headers used 
This is normally generated by another tool that crosstool-ng provides, but the config can be manually modified after being generated.
